...
export const AUDIT_EVENTS = [
  ...
  "user.group_membership.requested",
  "user.group_membership.request_cancelled",
  "user.deleted",
  "user.logout",
  ...
  "admin.user.password_added",
  "admin.user.password_deleted",
  ...
  "admin.group.updated",
  "admin.group.deleted",
  "admin.group.access_updated",
  "admin.group.member_added",
  "admin.group.member_removed",
  "admin.group.membership_request_approved",
  "admin.group.membership_request_rejected",
