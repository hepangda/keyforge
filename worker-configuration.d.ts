/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 16ffc38d5e13950a6e0e75e53b13a04d)
// Runtime types generated with workerd@1.20260722.1 2026-06-01 nodejs_compat
interface __BaseEnv_Env {
	...
	AUDIT_QUEUE: Queue;
	EMAIL_QUEUE: Queue;
	ISSUER: "https://auth-dev.pangda.app" | "https://auth.pangda.app" | "http://localhost:17001";
	ENVIRONMENT: "dev" | "production" | "local";
	EMAIL_DELIVERY_MODE: "resend" | "console";
	KEY_ROTATION_INTERVAL_SECONDS: "604800";
	TERMINAL_DATA_RETENTION_DAYS: "14" | "30";
	AUDIT_D1_RETENTION_DAYS: "90" | "365";
	MAINTENANCE_BATCH_SIZE: "100";
	MAINTENANCE_LEASE_SECONDS: "900";
	YOLO_MODE?: "true";
	RESEND_API_KEY?: string;
	EMAIL_FROM?: string;
	REQUEST_HASH_SECRET?: string;
	READINESS_PROBE_TOKEN?: string;
	AUTHORIZATION_CODE: DurableObjectNamespace<import("./src/index").AuthorizationCodeDO>;
	ONE_TIME_TOKEN: DurableObjectNamespace<import("./src/index").OneTimeTokenDO>;
	WEBAUTHN_CHALLENGE: DurableObjectNamespace<import("./src/index").WebAuthnChallengeDO>;
	REFRESH_TOKEN_FAMILY: DurableObjectNamespace<import("./src/index").RefreshTokenFamilyDO>;
	RATE_LIMIT: DurableObjectNamespace<import("./src/index").RateLimitDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "AuthorizationCodeDO" | "OneTimeTokenDO" | "WebAuthnChallengeDO" | "RefreshTokenFamilyDO" | "RateLimitDO";
	}
	interface DevEnv {
		KV: KVNamespace;
		AVATARS: R2Bucket;
		...
		KEY_ROTATION_INTERVAL_SECONDS: "604800";
		TERMINAL_DATA_RETENTION_DAYS: "14";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ISSUER" | "ENVIRONMENT" | "EMAIL_DELIVERY_MODE" | "KEY_ROTATION_INTERVAL_SECONDS" | "TERMINAL_DATA_RETENTION_DAYS" | "AUDIT_D1_RETENTION_DAYS" | "MAINTENANCE_BATCH_SIZE" | "MAINTENANCE_LEASE_SECONDS" | "YOLO_MODE" | "RESEND_API_KEY" | "EMAIL_FROM" | "REQUEST_HASH_SECRET" | "READINESS_PROBE_TOKEN">> {}
}
